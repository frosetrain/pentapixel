...
const toolIcons = [
    ...
    // line
    `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-slash-lg" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M13.854 2.146a.5.5 0 0 1 0 .708l-11 11a.5.5 0 0 1-.708-.708l11-11a.5.5 0 0 1 .708 0Z"/></svg>`,
];
const twColors = [
    "#ef4444",
    "#f97316",
...
function setup() {
    ...
    for (let i = 0; i < 4; ++i) {
        ...
        const callback = function () {
            ...
            if (tool === 0) {
                colorPickerDiv.addClass("hidden");
                console.log("hide");
            } else {
    ...
    bottomBar = createDiv();
    bottomBar.position(0, height - 100);
    bottomBar.class("flex w-screen p-4 gap-8");
    colorPickerDiv = createDiv();
    colorPickerDiv.parent(bottomBar);
    colorPickerDiv.class(
        "hidden flex w-min shadow rounded-lg bg-gray-200 dark:bg-gray-800 p-3 gap-4" +
            transition
    );
